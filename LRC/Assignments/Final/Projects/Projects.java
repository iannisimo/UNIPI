...
public class Projects {
    ...
    public static void init() throws IOException, ParseException {
        ...
        for (File project : projectsDir.listFiles(File::isDirectory)) {
            ...
            Project proj = new Project(projectName, members.remove(0), false);
            ...
            for(String cardName : cards) {
                ...
                Card c = proj.getCard(cardName);
                List<Long> history = (List<Long>) cMap.get("history");
                for(Long l : history) {
                    if(l.equals(0)) continue;
                    Status s = Status.fromOrdinal(l.intValue());
                    c.move(c.getStatus(), s);
                }
            }
