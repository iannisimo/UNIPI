...
public class Const {
    ...
    public static final String UNAME_REGEX = "^[a-zA-Z0-9._-]{3,}$";
    public static final String TF_REGEX = "^[a-zA-Z0-9\\s._-]{1,}$";
    public static final String DESC_REGEX = "^[a-zA-Z0-9\\s._-]{1,}$";
