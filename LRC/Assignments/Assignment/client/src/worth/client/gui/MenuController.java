...
import worth.client.utils.NoSelectionModel;
...
public class MenuController {
    ...
    private boolean showCardDialog(Card c, Status from) {
        ...
        dialog.setHeaderText("The history of movements of \"" + card +  "\" is:");
    ...
    private void addMemberAction(Event e) {
        ...
        if(notMembers.size() == 0) {
            Utils.InfoAlert("All users are already members of this project").show();
            return;
        }
        ChoiceDialog<String> dialog = new ChoiceDialog<>(notMembers.get(0), notMembers);
    ...
    private void refreshProjects() {
        ...
        if(!r.getStatus()) Utils.showErrorAndExit("Cannot retrieve the list of projects");
